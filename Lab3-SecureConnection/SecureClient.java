  ...
  // The method used to start a client object
	public void run() {
		try {
			...
			ks.load( new FileInputStream( "C:/Users/Victor/Desktop/Client/"+KEYSTORE ), KEYSTOREPASS.toCharArray() );
			
			KeyStore ts = KeyStore.getInstance( "JCEKS" );
			ts.load( new FileInputStream( "C:/Users/Victor/Desktop/Client/"+TRUSTSTORE ), TRUSTSTOREPASS.toCharArray() );
			...
			//String numbers = "1.0 3.0";
			System.out.print("Enter option 1: Download, 2: Upload or 3: Delete ");
			Scanner keyboard = new Scanner(System.in);
			System.out.println("enter an integer");
			int myint = keyboard.nextInt();
			
			String numbers = String.valueOf(myint);
